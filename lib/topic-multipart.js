...
exports.handlePartData = function (redisClient, type, amqp, topicId, data) {
    ...
    if (redisClient.hlen(key) === data.part[1]) {
        queuePartData(redisClient, key, type, topicId, amqp);
    }
};

function queuePartData (redisClient, key, type, topicId, amqp) {
        ...
        .exec(function (err, device) {
            ...
            amqp.then (function(conn) {
                ...
                assetPromise.then(function (asset) {
                    ...
                    let docPromise = buildPartDocs(redisClient, key, type, asset, device, eventId);
...
function buildPartDocs (redisClient, key, type, asset, device, eventId) {
