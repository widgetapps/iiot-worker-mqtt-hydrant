...
let Device   = require('@terepac/terepac-models').Device,
...
exports.handleData = function(amqp, data, topicId) {
...
exports.updateGeolocation = function (topicId, latitude, longitude) {
...
exports.deviceResetLog = function (topicId, data) {
